...
const HotelReviews = () => {
  ...
  const { hotelReviews, loading, error } = useSelector((state) => state.reviews);
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '0.5rem' }}>
              <Link 
                ...
                style={{ color: '#B45F3A', textDecoration: 'none', marginRight: '0.5rem' }}
              >
            ...
            <div style={{ 
              ...
              <div style={{ flex: '1' }}>
                <div style={{ 
                  ...
                  <span style={{ fontSize: '1rem', color: '#8A8A8A', marginLeft: '0.5rem' }}>
                    / 5
                  </span>
                </div>
              ...
              <div style={{ flex: '2' }}>
                <h3 style={{ marginBottom: '1rem', color: '#1A1A1A' }}>Rating Distribution</h3>
                {getRatingDistribution().map((count, index) => {
                  const starNumber = 5 - index;
                  const percentage = hotelReviews.length ? (count / hotelReviews.length) * 100 : 0;
                  
                  return (
                    <div key={index} style={{ display: 'flex', alignItems: 'center', marginBottom: '0.5rem' }}>
                      <div style={{ width: '60px', textAlign: 'right', marginRight: '0.5rem' }}>
                      ...
                      <div style={{ width: '40px', marginLeft: '0.5rem', color: '#8A8A8A' }}>
                        {count}
                      </div>
                    </div>
                  );
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                  <div>
                    ...
                    <h3 style={{ 
                      ...
                      <span style={{ marginRight: '8px' }}>{review.rating}-Star</span>
                      <span style={{ color: '#555' }}>Review by {review.user_details.username}</span>
                    </h3>
                  </div>
