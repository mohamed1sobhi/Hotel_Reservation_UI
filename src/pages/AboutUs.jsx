      ...
      <div className="about-content" style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '3rem' }}>
        <section style={{ display: 'flex', alignItems: 'center', gap: '2rem', flexWrap: 'wrap' }}>
          <div style={{ flex: '1', minWidth: '300px' }}>
            <h2 style={{ color: 'var(--bs-primary)', marginBottom: '1rem' }}>Our Story</h2>
        ...
        <section style={{ backgroundColor: '#1A1A1A', padding: '3rem', borderRadius: '8px', color: '#F9F5F1' }}>
          <h2 style={{ color: 'var(--bs-primary)', marginBottom: '1.5rem', textAlign: 'center' }}>What Sets Us Apart</h2>
          <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '2rem' }}>
            <div style={{ flex: '1', minWidth: '250px' }}>
              <h3 style={{ color: 'var(--bs-primary)', marginBottom: '1rem' }}>Curated Selection</h3>
              <p style={{ lineHeight: '1.6' }}>We personally vet each hotel in our collection to ensure quality and authenticity.</p>
            </div>
            <div style={{ flex: '1', minWidth: '250px' }}>
              <h3 style={{ color: 'var(--bs-primary)', marginBottom: '1rem' }}>Best Price Guarantee</h3>
              <p style={{ lineHeight: '1.6' }}>Find a lower price elsewhere? We'll match it and give you an additional discount.</p>
            </div>
            <div style={{ flex: '1', minWidth: '250px' }}>
              <h3 style={{ color: 'var(--bs-primary)', marginBottom: '1rem' }}>24/7 Support</h3>
        ...
        <section>
          <h2 style={{ color: 'var(--bs-primary)', marginBottom: '1.5rem' }}>Our Team</h2>
        ...
        <section style={{ textAlign: 'center', margin: '2rem 0' }}>
          <h2 style={{ color: 'var(--bs-primary)', marginBottom: '1.5rem' }}>Ready to Find Your Perfect Stay?</h2>
