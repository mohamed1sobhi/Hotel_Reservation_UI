  ...
  return (
    <>
      ...
      <div className="cover-section text-center text-color d-flex align-items-center justify-content-center">
        <div>
        <img src="src/assests/HOTEL_LOGO.svg" alt="" style={
            { width: "300px", height: "200px"  }
          } />
          <h1 className="display-4 fw-bold animate-fade-in">Welcome to Our Hotel Platform</h1>
          <p className="lead animate-slide-up">Discover luxury hotels and unforgettable experiences</p>
          <Link
            to="/hotels"
      ...
      <div className="py-5 top-hotels-section">
        ...
        <section className="mb-5 rounded shadow-sm p-4">
          ...
          <div style={{ width: "290px", height: "4px", backgroundColor: "#CD9A5E", margin: "20px auto" }}></div>
          {hotelsLoading ? (
            ...
            >
              {topHotels.map((hotel) => (
                <SwiperSlide key={hotel.id}>
                  <div className="card h-100 shadow-sm hotel-card " style={{ backgroundColor: "#CD9A5E" }}>
                    <img
                      src={
                      ...
                      style={{ objectFit: "cover", height: "400px"  ,backgroundColor: "#E8DFD5"}}
                    />
                    <div className="card-body">
                      <h5 className="card-title fw-bold text-info">{hotel.name}</h5>
...
<span className="text-primary">                          View Details
</span>                        </Link>
    ...
    <div className="row g-4">
      <div className="col-md-4 text-center">
        <div className="feature-card p-4 shadow-sm rounded bg-primary">
          ...
          <p className="text-light">Experience the best in luxury and comfort.</p>
        </div>
      </div>
      <div className="col-md-4 text-center">
        <div className="feature-card p-4 shadow-sm rounded  bg-primary">
          ...
          <p className="text-light">Your data is safe with us. Book with confidence.</p>
        </div>
      </div>
      <div className="col-md-4 text-center ">
        <div className="feature-card p-4 shadow-sm rounded bg-primary">
          ...
          <p className="text-light">Our team is here to assist you at any time.</p>
        </div>
      </div>
    </div>
  </div>
          ...
          <SwiperSlide key={review.id}>
            <div className="card h-100 shadow-sm review-card p-4 bg-primary">
              ...
              <div className="card-body text-center">
                <p className="card-text  text-light " style={{fontSize:"1.3rem" }}>"{review.comment}"</p>
