...
export default function RoomsPage() {
  ...
  if (loading) {
    return (
      <div className="d-flex justify-content-center align-items-center min-vh-100" style={{ backgroundColor: "#F9F5F1" }}>
        <div className="spinner-border" role="status" style={{ color: "#CD9A5E" }}></div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="container py-5" style={{ backgroundColor: "#F9F5F1" }}>
        <div className="alert" style={{ backgroundColor: "#E8DFD5", color: "#1A1A1A", border: "1px solid #B45E3A" }}>
  ...
  return (
    <div style={{ backgroundColor: "#F9F5F1", minHeight: "100vh", padding: "40px 0" }}>
      <div className="container">
        ...
        {!rooms || rooms.length === 0 ? (
          <div className="text-center py-5" style={{ backgroundColor: "#E8DFD5", borderRadius: "12px", padding: "40px" }}>
            <h2 style={{ color: "#8A8A8A" }}>No rooms available at this time</h2>
            <p style={{ color: "#8A8A8A" }}>Please check back later or contact us for assistance</p>
          </div>
        ) : (
            ...
            {rooms.map((room) => (
              <div key={room.id} className="col-md-6 col-lg-4 mb-4">
                <div 
                  ...
                  style={{ 
                    boxShadow: hoveredRoom === room.id ? "0 15px 35px rgba(205, 154, 94, 0.15)" : "0 5px 15px rgba(0, 0, 0, 0.05)",
                    borderRadius: "12px",
                ...
                >
                  <div 
                    style={{ 
                      height: "180px", 
                      background: "linear-gradient(45deg, #CD9A5E 0%, #B45E3A 100%)",
                      position: "relative",
                      display: "flex",
                      alignItems: "center",
                  ...
                  <div className="card-body p-4">
                    ...
                    <div style={{ marginBottom: "20px" }}>
                      ...
                      <div className="d-flex flex-wrap gap-2">
                        {formatAmenities(room.amenities).map((amenity, idx) => (
                          <span 
                            key={idx}
